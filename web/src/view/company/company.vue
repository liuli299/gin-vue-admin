<template>
  <div>
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="统一社会信用代码">
          <el-input v-model="searchInfo.creditCode" placeholder="搜索条件" />
        </el-form-item>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="企业名称" prop="name" width="120" />
        <el-table-column align="left" label="社会信用代码" prop="creditCode" width="120" />
        <el-table-column align="left" label="法人类型" prop="type" width="120" />
        <el-table-column align="left" label="企业id" prop="companyId" width="120" />
        <el-table-column align="left" label="法人" prop="legalPersonName" width="120" />
        <el-table-column align="left" label="企业状态" prop="regStatus" width="120" />
        <el-table-column align="left" label="行业分类门类" prop="category" width="120" />
        <el-table-column align="left" label="行业分类大类" prop="categoryBig" width="120" />
        <el-table-column align="left" label="行业分类中类" prop="categoryMiddle" width="120" />
        <el-table-column align="left" label="行业分类小类" prop="categorySmall" width="120" />
        <el-table-column align="left" label="行业" prop="industry" width="120" />
        <el-table-column align="left" label="省份简称" prop="base" width="120" />
        <el-table-column align="left" label="市" prop="city" width="120" />
        <el-table-column align="left" label="区" prop="district" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="text" icon="edit" size="small" class="table-button" @click="updateCompanyFunc(scope.row)">变更</el-button>
